...
public class akbone_neopixel_init  extends TranslatorBlock {

	public akbone_neopixel_init (Long blockId, Translator translator, String codePrefix, String codeSuffix, String label)
	{
